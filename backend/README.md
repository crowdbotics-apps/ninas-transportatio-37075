...
## Project Structure
    ...
    ├── ninas_transportatio_37075  # Django project configurations
...
1. Clone this repo and `cd ninas_transportatio_37075`
...
2. Clone this repo and `cd ninas_transportatio_37075`
